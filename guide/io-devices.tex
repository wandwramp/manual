...
Table~\ref{table:base_addr}. The memory addresses for specific
elements of each device can be found both in their respective sections 
of this chapter, and in Appendix~\ref{appendix:memory-map}. The details
of how to use each of the devices forms the body of this document.
