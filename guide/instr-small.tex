...
This form of the instruction set will be the reference that you are provided with in tests. It is important that you make sure that you can understand it.

Here are a few points on the notation used:
...
\item On instruction fetch the Program Counter is incremented. This means that branch instructions operate relative to the address of the following instruction, and \src{jal} and \src{jalr} instructions save the address of the following instruction.
\end{itemize}
