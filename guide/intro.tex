...
to 0x03FFF. The last \todo{Check: Is this still 2K words? That's a lot!} 2K words are reserved for use by the monitor program. The rest 
...
into the board's memory. This can be done by settin the board into \src{load}
