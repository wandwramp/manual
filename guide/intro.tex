...
for example, \src{text\_size} will usually be the number of instructions
in the \src{.text} section, and will also point to the start of the
\src{.data} section. These sections are discussed below.
...
\src{man 7 ascii}, show octal representations to make writing these easier.
