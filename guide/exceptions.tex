...
Exceptions can be thought of as similar to subroutine calls. The processor is executing a block of code when an exception occurs,
...
other locations in this register beside the ones specified.
...
The five exception related registers mentioned at the start of this chapter and four more discussed here.  
