...
Excercise Test Date:~\CWRAMPTEST\\
}
...
file \filename{/home201/lib.h}. Your C code must
...
\filename{/home/201/ex4/main.c}. The function 
...
in the file \filename{/home/210/ex4/ctrl.c}. This 
...
given in \filename{/home/201/ex4/main.o} and 
\filename{/home/201/ex4/ctrl.o} respectively.
...
\begin{verbatim}
     wlink ­o ex4_1.srec counter.o /home.201/ex4/main.o 
              /home/201/ex4/ctrl.o /home/201/lib.o
\end{verbatim}

This links together your \src{counter} function and the provided 
\src{main}, \src{counter\_ctrl} and library
functions into one uploadable file called \filename{ex4\_1.srec}.
...
\begin{verbatim}
     wlink ­o ex4_2.srec counter.o my_ctrl.o
           /home/201/ex4/main.o /home/201/lib.o
\end{verbatim}

You should now have a file named \filename{ex4\_2.srec} 
...
\section{Appendix - Excercise 4 Library Routines}
...
will display the lowest order byte (bits 0-7) of the first argument as
