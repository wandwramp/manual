...
clean:
	...
	-rm $(wildcard output/guides/ps/*.ps )
	-rm $(wildcard output/guides/pdf/*.pdf )
	-rm $(wildcard output/exercises/ps/*.ps )
	-rm $(wildcard output/exercises/pdf/*.pdf )
	-rm $(wildcard output/instr/ps/*.ps )
	-rm $(wildcard output/instr/pdf/*.pdf )
	-rm $(wildcard output/book/ps/*.ps )
	-rm $(wildcard output/book/pdf/*.pdf )
